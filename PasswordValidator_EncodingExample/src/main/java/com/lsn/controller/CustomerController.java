...
public class CustomerController {
	...
	public ModelAndView saveEmployeeAction(@ModelAttribute("customer") Customer customer, BindingResult bindingResult,
			ModelAndView model) {
		...
		System.out.println("Changed password is :" + hashedPassword);
		...
		// model.addObject("password", hashedPassword);
